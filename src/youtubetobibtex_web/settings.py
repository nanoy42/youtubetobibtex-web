...
ROOT_URLCONF = "youtubetobibtex_web.urls"
...
WSGI_APPLICATION = "youtubetobibtex_web.wsgi.application"
...
try:
    from youtubetobibtex_web.local_settings import *
except:
    if "test" not in sys.argv or "test_coverage" in sys.argv:
        raise Exception(
            "No local_settings.py file found in youtubetobibtex_web directory"
        )
